...
describe('Upsert query compiler', () => {
  it('accepts props with table, columns and records', () => {
    ...
    assert.strictEqual(query.sql, 'INSERT INTO `employees` (`id`, `firstname`, `lastname`, `age`) ' +
